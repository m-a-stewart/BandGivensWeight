program test_decomp
  ...
  test_name="Real UB;"
  call d_output_result(test_name,a0,a1,rmax,ub_d%ubw,t0,t0,tol2,error)
  ! square termination.
  u=u0; v=v0;
  ...
  test_name="Real BV;"
  call d_output_result(test_name,a0,a1,rmax,bv_d%ubw,t0,t0,tol2,error)
  ...
  print *
  u_c=u0_c; v_c=v0_c
  call c_assemble_a(a_c,u_c,v_c,dc,lbw)
  a0_c=a_c
  call cpu_time(t0)
  ...
  call c_output_result(test_name,a0_c,a1_c,rmax,ub_c%ubw,t0,t0,tol2,error)
